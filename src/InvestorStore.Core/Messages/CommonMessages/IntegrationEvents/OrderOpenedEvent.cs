...
{
    public class OrderOpenedEvent : IntegrationEvent
    {
        ...
        public OrderOpenedEvent(Guid orderId, Guid customerId, decimal total, OrderProducts orderProducts, string cardName, string cardNumber, string cardExpiryDate, string cardCvvCode)
        {
            OrderId = orderId;
